...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.dbs = {
            'attraction': 'attraction_db_processed.json',
            'hospital': 'hospital_db_processed.json',
            'hotel': 'hotel_db_processed.json',
            'police': 'police_db_processed.json',
            'restaurant': 'restaurant_db_processed.json',
            'taxi': 'taxi_db_processed.json',
            'train': 'train_db_processed.json',
        }
        self.glove_path = './data/glove/glove.6B.50d.txt'
        self.domain_file_path = 'data/multi-woz-processed/domain_files.json'
        self.slot_value_set_path = 'value_set_processed.json'

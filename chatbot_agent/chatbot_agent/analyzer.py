...
from chatbot_agent.session import BiSession
from chatbot_agent.evaluator.multiwoz_eval import MultiWozEvaluator
from pprint import pprint
import random
import numpy as np
import torch
import matplotlib.pyplot as plt
from chatbot_agent.reporter import Reporter
from tqdm import tqdm, trange
import logging


class Analyzer:
    def __init__(self, db_path, user_agent, dataset='multiwoz'):
    ...
    def build_sess(self, sys_agent):
        if self.dataset == 'multiwoz':
            evaluator = MultiWozEvaluator(self.db_path)
        else:
            evaluator = None

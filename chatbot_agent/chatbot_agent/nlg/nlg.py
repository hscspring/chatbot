...
import collections
from chatbot_agent.interface.nlg import NLG
...
class TemplateNLG(NLG):
    def __init__(self, is_user, template_dir, mode="manual"):
        """
        Args:
            is_user:
...
def example():
    ...
    template_dir = "/Users/Yam/Yam/chatbot/chatbot/data/template"

    # system model for manual, auto, auto_manual
    nlg_sys_manual = TemplateNLG(is_user=False, template_dir=template_dir, mode='manual')
    nlg_sys_auto = TemplateNLG(is_user=False, template_dir=template_dir, mode='auto')
    nlg_sys_auto_manual = TemplateNLG(is_user=False, template_dir=template_dir, mode='auto_manual')
